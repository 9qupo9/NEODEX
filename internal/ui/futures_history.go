...
func RenderFuturesHistory() string {
	return `
	<div class="history-panel" style="flex: 1; border-top: 1px solid var(--border-color); display: flex; flex-direction: column;">
		<div class="history-tabs" style="display: flex; border-bottom: 1px solid var(--border-color);">
			<div class="tab history-tab-btn active" data-tab="positions" style="flex: 1; text-align: center; padding: 10px 0; font-size: 11px; cursor: pointer; color: var(--color-accent); border-bottom: 2px solid var(--color-accent);">Positions(0)</div>
			<div class="tab history-tab-btn" data-tab="open" style="flex: 1; text-align: center; padding: 10px 0; font-size: 11px; cursor: pointer; color: var(--text-muted); border-bottom: 2px solid transparent;">Open Orders(0)</div>
		...
		<div class="table-container" style="flex: 1; overflow-y: auto;">
			<!-- Positions Table -->
			<table id="positionsTable" style="display: table; width: 100%;">
				<thead>
					<tr>
						<th>Symbol</th>
						<th>Side</th>
			...
			<!-- Open Orders Table (hidden by default) -->
			<table id="historyTable" style="display: none; width: 100%;">
				<thead>
					<tr>
						<th>Side</th>
						<th>Price</th>
			...
			<div id="historyEmptyState" class="empty-state" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 30px; color: var(--text-muted); font-size: 12px;">
				...
				<div style="margin-top: 10px;" id="historyEmptyText">No Open Positions</div>
			</div>
		</div>
	</div>
	`
