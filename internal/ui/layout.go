...
func RenderSpotPage() string {
	return `<!DOCTYPE html>
<html lang="ru">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>NEODEX - Crypto Exchange</title>
    ` + RenderCSS() + `
</head>
<body>
    ...
    <div id="marketModal" class="market-modal-overlay" style="display:none;">
        <div class="market-modal">
            ...
            <div class="market-modal-tabs">
                ...
                <button class="market-tab" data-quote="BTC">BTC</button>
                <button class="market-tab" data-quote="ETH">ETH</button>
            </div>
